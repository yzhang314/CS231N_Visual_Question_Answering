...
from language_model import WordEmbedding, QuestionEmbedding1
...
class CNNModel(nn.Module):
    ...
    def forward(self, v, b, q, labels):
        ...
        v_emb1 = (att * v).sum(1)  # [batch, num_hid]
...
def build_baseline0(dataset, num_hid):
    ...
    return CNNModel(w_emb, q_emb, v_att, q_net, v_net, classifier, linear)
